...
exports.language_selection = {
    parse_mode: 'Markdown',
    reply_markup: {
        remove_keyboard: true,
        inline_keyboard: [
            [
                { text: 'ភាសាខ្មែរ', callback_data: 'lang_kh' },
...
exports.main_menu_button_option_en = {
    parse_mode: 'Markdown',
    caption: '',
    reply_markup: {
      inline_keyboard: [
...
exports.product_option_button_en = {
    caption: '',
    parse_mode: 'Markdown',
    reply_markup: {
        inline_keyboard: [
...
exports.product_short_savings_option_en = {
    caption: '',
    parse_mode: 'Markdown',
    reply_markup: {
        inline_keyboard: [
...
exports.multiple_choice_answers_en = {
...
exports.live_chat_agent_response_en = {
    caption: '',
    parse_mode: 'Markdown',
    reply_markup: {
        inline_keyboard: [
...
exports.agent_main_option_button_en = {
  caption: '',
  parse_mode: 'Markdown',
  reply_markup: {
    inline_keyboard: [
...
exports.agent_customer_list_option_button_en = {
  caption: '',
  parse_mode: 'Markdown',
  reply_markup: {
    inline_keyboard: [
